...
function supermarket_scripts() {
	...
	array_push( $supermarket_googlefont, 'Verona');
	...
	if ($supermarket_settings['supermarket_enable_fixed_height'] !=0){
		$supermarket_internal_css .= '/* Fixed height(Two line) product title */
