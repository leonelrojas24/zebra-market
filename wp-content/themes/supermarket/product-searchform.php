...
<form role="search" method="get" class="woocommerce-product-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<select class="search-categories-select" name="product_cat">
		...
		<option value="0"><?php esc_html_e('Categorias','supermarket'); ?></option>
		<?php
		$args = array(
	...
	<label class="screen-reader-text" for="woocommerce-product-search-field-0"><?php esc_html_e('Buscar','supermarket'); ?></label>
		...
		<button type="submit" value="Search"><?php esc_html_e('Buscar','supermarket');?></button>
